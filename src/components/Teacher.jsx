...
function Teacher(){
    ...
    return(
        <div className="flex flex-col justify-center items-center md:gap-6 gap-8 ">
            ...
            <div className={`flex flex-col justify-center items-center w-3/4 md:w-fit gap-2 md:p-7 pt-5 pb-7 md:pb-12 rounded mt-16 ${darkMode ? "bg-sky-900" : "bg-sky-200"}`}>
                <img src="/photos/khwarizmi2.jpeg" alt="teacher" className="md:h-96 h-52 rounded"></img>
                <div className="flex flex-col justify-center items-center text-center md:gap-4 md:pt-6 pt-4 gap-2 md:text-xl text-lg font-poppins">
